...
bot = telegram.Bot(token = '121509342:AAFXx3W76vHz7Y3RTjIMpd0BiCyBD3l37J0')
...
bot.sendMessage(chat_id=chat_id, text="Здорово, товарищ! Выбери правильное значение для слова: " + row1, reply_markup=reply_markup)
